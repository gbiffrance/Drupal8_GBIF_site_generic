...
class __TwigTemplate_251a8baf68e19df0c19b249773eddd79ca693ab4a853edaab123b3bf93f3b42d extends \Twig\Template
{
...
($context["settings"] ?? null), "thumbnail_position", []))) ? (("slick-wrapper--tn-" . twig_replace_filter($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["settings"] ?? null), "thumbnail_position", [])), ["over-" => ""]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "modules/contrib/slick/templates/slick-wrapper.html.twig", "/data/www/html/site-test/modules/contrib/slick/templates/slick-wrapper.html.twig");
    }
}
